...
namespace PerfectHotel.Web.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new ApplicationUser { UserName = Input.Email, Email = Input.Email, TenantId = Input.TenantId, TenantName = Input.TenantName};
